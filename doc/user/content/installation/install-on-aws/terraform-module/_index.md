...
| Karpenter | Auto-scaling controller with two node classes:<br>- Generic nodepool: t4g.xlarge instances for general workloads<br>- Materialize nodepool: r7gd.2xlarge instances with swap enabled and dedicated taints to run materialize instance workloads |
