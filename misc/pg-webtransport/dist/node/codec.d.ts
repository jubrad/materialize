 ...
 */
export declare function encodeCancelRequest(pid: number, secretKey: number): Uint8Array;
...
export type BackendMessage = AuthenticationOk | AuthenticationCleartextPassword | AuthenticationMD5Password | AuthenticationSASL | AuthenticationSASLContinue | AuthenticationSASLFinal | ParameterStatus | BackendKeyData | ReadyForQuery | RowDescription | DataRow | CommandComplete | ErrorResponse | NoticeResponse | NotificationResponse | ParseComplete | BindComplete | NoData | PortalSuspended | EmptyQueryResponse | CloseComplete;
